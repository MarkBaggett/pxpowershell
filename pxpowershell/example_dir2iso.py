...
powershell_script = r"""function New-IsoFile 
{  
  <#  
   .Synopsis  
   ...
   .Notes 
    NAME:  New-IsoFile  
    AUTHOR: Chris Wu 
    Modified: Mark Baggett 6-10-21 - Do not include base folder. 
 #>
...
"""
#Script such as this will break pxpowershell without at least one new lines after the }.  Without it the prompt never returns
